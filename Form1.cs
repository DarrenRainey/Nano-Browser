...
namespace SimpleWebBrowser
{
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show("Nano Browser V1.00 By DarrenRainey this browser is designed for low powered PC's and to save memmory recources such as RAM and Stoarage)");
        }
